...
public class Helper {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                if (disposition != null) {
                    ...
                    if (index > 0) {
                        ...
                        System.out.println("No filename in Content-Disposition header!");
                    }
                } else {
                    System.out.println("No Content-Disposition header!");
                }
            } else {
    ...
    public int runCommand(List<String> params) {
        System.out.println("Command string: "+ String.join(" ", params));
